...
from policy_based import ReinforceAgent, A2CGAEAgent
...
def main(opt):
    ...
    agent = A2CGAEAgent(input_shape, num_actions, writer)
    # main loop
    ...
    while step_cnt < opt.steps:
        ...
        while not done:
            ...
            obs = next_obs
            step_cnt += 1
            if step_cnt % opt.nsteps == 0 or done:
                agent.update_policy(step_cnt, done, next_obs)
